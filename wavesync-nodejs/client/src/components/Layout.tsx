  ...
  return (
    <div className="h-screen w-screen flex flex-col bg-background text-foreground overflow-hidden relative">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        {/* Floating Particles - Show on all devices */}
        {[...Array(15)].map((_, i) => (
          <div
            key={i}
            className="absolute rounded-full bg-cyan-400/10 float-animation"
            style={{
        ...
        {/* Radial Gradients - Full size on all devices */}
      ...
      <div className="flex flex-1 overflow-hidden relative z-10 w-full">
        ...
        <div className="flex-1 flex flex-col overflow-hidden min-w-0">
          ...
          <main className="flex-1 overflow-y-auto overflow-x-hidden bg-gradient-to-b from-muted/20 to-background px-3 py-3 sm:px-4 sm:py-4 md:px-6 md:py-6">
            <Outlet />
          </main>
        </div>
      </div>
